...
EPOCHS = 30
LR = 0.0001
MODEL_SAVE_PATH = "./deeplab_resnet50_custom.h5"

# ==========================================
# 2. DATA LOADER (The Robust Version)
# ==========================================
class Dataset:
    ...
    def __getitem__(self, i):
        ...
        # Convert to Binary (Background vs Object)
...
# ==========================================
# 3. MODEL: DEEPLABV3+ (ResNet50 Backbone)
# ==========================================
def ASPP(inputs):
    shape = inputs.shape
...
# Build & Compile
print("🏗️ Building DeepLabV3+ (ResNet50)...")
model = build_deeplab((TARGET_SIZE[0], TARGET_SIZE[1], 3))
