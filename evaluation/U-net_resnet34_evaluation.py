...
# ⚠️ CHECK THIS PATH: Make sure it points to your ResNet34 file
# (e.g., unet_resnet34_customxx.h5 or whatever you named it)
MODEL_PATH = "/content/drive/MyDrive/saved_models/pastis_planner_model_V2.h5"

DATA_DIR = "/content/PASTIS_Fixed"
TARGET_SIZE = (160, 160) # Must stay 160x160 for ResNet34
...
# Get ResNet34 specific preprocessing
